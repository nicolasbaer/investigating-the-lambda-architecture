...
def start_service(service, mapping, path, v_node_num, sleep=True):
    if service == "service_monitor":
        ...
        sh.bash("install_service_monitor.sh")
        print "finished starting service monitor"

    if service == "zookeeper":
        print "starting zookeeper"
        sh.bash("install_zookeeper.sh")
    ...
    if service == "nimbus":
        ...
        sh.bash(os.path.join(path, "install_storm_nimbus.sh"), mapping["zookeeper"])
    ...
    if service == "namenode":
        ...
        sh.bash(os.path.join(path, "install_yarn_namenode.sh"), mapping["namenode"])
    ...
    if service == "resourcemanager":
        ...
        sh.bash(os.path.join(path, "install_yarn_resourcemanager.sh"), mapping["namenode"])
        print "finished starting yarn resourcemanager"

    if service == "logging":
        print "starting logging engine"
        sh.bash(os.path.join(path, "install_logging.sh"))
    ...
    if service == "kafka":
        ...
        sh.bash(os.path.join(path, "install_kafka_broker.sh"), mapping["zookeeper"], v_node_num)
    ...
    if service == "yarn":
        ...
        sh.bash(os.path.join(path, "install_yarn_nodemanager.sh"), mapping["namenode"], mapping["resourcemanager"],
                v_node_num)
    ...
    if service == "supervisor":
        ...
        sh.bash(os.path.join(path, "install_storm_supervisor.sh"), mapping["zookeeper"], mapping["nimbus"], v_node_num)
    ...
    if service == "mongodb":
        ...
        sh.bash(os.path.join(path, "install_mongodb.sh"))
    ...
    if service == "redis":
        ...
        sh.bash(os.path.join(path, "install_redis.sh"))
    ...
    if service == "collectd":
        ...
        sh.bash(os.path.join(path, "install_collectd.sh"), mapping["logging"])
