package ch.uzh.ddis.thesis.lambda_architecture.coordination.timesynchronizer;

import ch.uzh.ddis.thesis.lambda_architecture.coordination.producer.IProducer;
 ...
 * is bound to the system time. The synchronizer does not distinct between different producers and therefore no message
 * precendence is provided.
 *
...
public final class SystemTimeSynchronizer implements EventHandler<IDataEntry> {
    ...
    /**
     * Incoming messages are redirected to the given producer with regard to the configured throttling rate. Please
     * see the Disruptor project for further reference on the behavior of the ring buffer.
     *
     * @param data data to forward to the consumer.
     * @param sequence the sequence of the data
     * @param endOfBatch indication of a batch ending
     * @throws Exception
     */
    @Override
